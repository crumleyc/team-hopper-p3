...
parser.add_argument('--model', type=str, choices=['nmf', 'unet'], default='nmf', 
	help='model to find neurons')
parser.add_argument('--url', type=str, default='gs://uga-dsp/project3', 
	help='google storage bucket link')
parser.add_argument('--data', type=str, default='neuron_dataset', 
	help='name of folder to download neuron dataset into')
parser.add_argument('--train_opts', type=str, default='all', 
...
parser.add_argument('--test_opts', type=str, default='all', 
